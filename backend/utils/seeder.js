...
const seedDatabase = async () => {
  try {
    ...
    // 4. Define Package Data (UPDATED FOR NEW MODEL)
    const packagesData = [
      {
        title: 'Maasai Mara Safari Adventure',
        description: 'Experience the ultimate wildlife safari in Kenya\'s most famous national reserve. Witness the Great Migration, spot the Big Five, and immerse yourself in Maasai culture.',
        ...
        destination: 'Maasai Mara National Reserve',
        duration_days: 5,
        duration_nights: 4, // ✅ NEW
        category: 'wildlife',
        price_adult: 45000.00,
        price_child: 35000.00,
        discount_price: 42000.00, // ✅ NEW
        max_capacity: 12,
        is_featured: true,
        status: 'published',
        // ✅ UPDATED: JSON Array
        inclusions: ['Accommodation', 'All meals', 'Game drives', 'Park fees', 'Professional guide', 'Transport'],
        exclusions: ['International flights', 'Travel insurance', 'Tips', 'Personal expenses'],
        // ✅ UPDATED: JSON Array of Objects
        itinerary: [
          { day: 1, title: 'Arrival & Transfer', description: 'Pick up from Nairobi, drive to Mara, check-in.', activities: ['Road transfer', 'Welcome drink'] },
          { day: 2, title: 'Full Day Game Drive', description: 'Explore the reserve searching for the Big Five.', activities: ['Morning game drive', 'Picnic lunch', 'Evening drive'] },
          { day: 3, title: 'Mara River Crossing', description: 'Visit the river to witness hippos and crocodiles.', activities: ['River visit', 'Cultural village visit'] },
          { day: 4, title: 'Sunrise Safari', description: 'Early morning drive when animals are most active.', activities: ['Sunrise drive', 'Breakfast in the bush'] },
          { day: 5, title: 'Departure', description: 'Final short drive and return to Nairobi.', activities: ['Transfer to airport'] }
        ]
      },
      {
        title: 'Diani Beach Paradise Getaway',
        ...
        exclusions: ['Lunch', 'Water sports', 'Spa treatments', 'Travel insurance'],
        itinerary: [
          { day: 1, title: 'Arrival in Diani', description: 'Fly or drive to Diani, check into hotel.', activities: ['Transfer', 'Check-in'] },
          { day: 2, title: 'Beach Relaxation', description: 'Free day to enjoy the white sands.', activities: ['Swimming', 'Sunbathing'] },
          { day: 3, title: 'Kisite Mpunguti Trip', description: 'Boat trip to the marine park for snorkeling.', activities: ['Snorkeling', 'Lunch on island'] },
          { day: 4, title: 'Departure', description: 'Breakfast and transfer back.', activities: ['Transfer'] }
        ]
      },
      {
        title: 'Mount Kenya Climbing Expedition',
        ...
        exclusions: ['Climbing gear rental', 'Travel insurance', 'Tips', 'Personal climbing equipment'],
        itinerary: [
          { day: 1, title: 'To Sirimon Gate', description: 'Drive to Nanyuki and start trekking.', activities: ['Trekking', 'Camping'] },
          { day: 2, title: 'To Old Moses Camp', description: 'Hike through bamboo zone.', activities: ['Hiking'] },
          { day: 3, title: 'To Shipton\'s Camp', description: 'Ascend to higher altitude moorland.', activities: ['Hiking', 'Acclimatization'] },
          { day: 4, title: 'Summit Day', description: 'Early rise to Point Lenana summit.', activities: ['Summit climb', 'Descent'] },
          { day: 5, title: 'Descent', description: 'Walk down to Chogoria gate.', activities: ['Trekking'] },
          { day: 6, title: 'Return to Nairobi', description: 'Drive back to city.', activities: ['Transfer'] }
        ]
      },
      {
        title: 'Lamu Island Cultural Experience',
        description: 'Discover the rich Swahili culture and history of Lamu Old Town, a UNESCO World Heritage Site. Explore ancient architecture and pristine beaches.',
        location: 'Mombasa (Flight to Lamu)',
        destination: 'Lamu Island',
        duration_days: 3,
        duration_nights: 2,
        category: 'cultural',
        ...
        exclusions: ['Flights', 'Travel insurance', 'Shopping', 'Optional activities'],
        itinerary: [
          { day: 1, title: 'Arrival in Lamu', description: 'Flight to Lamu, boat to hotel.', activities: ['Flight', 'Boat transfer'] },
          { day: 2, title: 'Old Town Tour', description: 'Walking tour of the narrow streets.', activities: ['Museum visit', 'Donkey ride'] },
          { day: 3, title: 'Manda Island', description: 'Trip to the ruins and beach.', activities: ['Boat trip', 'Snorkeling'] }
        ]
      },
      {
        title: 'Luxury Amboseli Safari',
        ...
        exclusions: ['Flights', 'Travel insurance', 'Tips', 'Spa treatments'],
        itinerary: [
          { day: 1, title: 'Nairobi to Amboseli', description: 'Scenic drive with Kilimanjaro views.', activities: ['Game drive en route'] },
          { day: 2, title: 'Elephant Exploration', description: 'Full day tracking elephant herds.', activities: ['Morning drive', 'Afternoon drive'] },
          { day: 3, title: 'Observation Hill', description: 'Hike for panoramic views.', activities: ['Hiking', 'Picnic'] },
          { day: 4, title: 'Return', description: 'Morning drive and return.', activities: ['Transfer'] }
        ]
      },
      {
        title: 'Budget Nairobi City Tour',
        ...
        exclusions: ['Lunch & dinner', 'Entrance fees to optional attractions', 'Personal expenses'],
        itinerary: [
          { day: 1, title: 'City Highlights', description: 'Visit Museum and Railway station.', activities: ['Museum visit', 'City walk'] },
          { day: 2, title: 'Wildlife & Market', description: 'Sheldrick elephants and Giraffe center.', activities: ['Elephant feeding', 'Giraffe center', 'Market shopping'] }
        ]
      }
    ];
    ...
    for (let i = 0; i < packagesData.length; i++) {
      ...
      const images = imageSets[i].map((photoId, index) => ({
        ...
        is_primary: index === 0,
        caption: `${createdPackage.title} - View ${index + 1}`,
        tour_package_id: createdPackage.id // Explicitly link to the package
      }));
    ...
    console.log('========================================');
    console.log('\nDefault Credentials:');
    console.log('👤 Admin:  admin@sharavista.com / admin123');
    console.log('👤 Client: john@example.com / client123');
    console.log('\n');
